...
def complete_matrix(user_input_list, public_input_list, assembly, correlation_file, public_matrix, output_matrix):
    ...
    """
    print 'python', config.COMPLETE_MATRIX, config.CHROM_SIZE[assembly], user_input_list, public_input_list, correlation_file, public_matrix, output_matrix
...
def main():
    ...
    correlate(user_input_list, public_input_list, args.assembly, user_zscore, public_zscore, correlation_file, args.resolution)
